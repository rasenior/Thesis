                  ...
                  ifelse(results$figure == "Fig. 3", "\\autoref{fig:fig-4-3}", 
                         ifelse(results$figure == "Fig. 4", "\\autoref{fig:fig-4-4}", 
                                ifelse(results$figure == "Fig. 5", "\\autoref{fig:fig-4-5}",
                                       ifelse(results$figure == "Fig. S1", "\\autoref{fig:fig-B-2}",
                                              ifelse(results$figure == "Fig. S2", "\\autoref{fig:fig-B-3}",
                                                     ifelse(results$figure == "Fig. S3", "\\autoref{fig:fig-B-4}", NA))))))))

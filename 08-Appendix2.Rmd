...
```{r fig-B-1, fig.width=8/2.54, fig.height=8/2.54, fig.cap= "Sampling design schematic."}
readRDS("figs/figB.1.Rds")
```
...
```{r fig-B-4, fig.cap= "(ref:cap-B-4)"}
readRDS("figs/figB.4.Rds")
```
...
```{r fig-B-2, fig.height = 20/2.54, fig.cap= "(ref:cap-B-2)"}
readRDS("figs/figB.2.Rds")
```

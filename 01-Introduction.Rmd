...
<!-- * Global extinction crisis, caused by humans -->
<!--     * Stats on number of species lost compared to past -->
<!-- * Main ways in which humans drive extinction -->
<!--     * Land-use change, climate change, pollution, over-exploitation and invasive species -->
...
<!--     * Remaining pristine habitat, on which a disproportionate number of species depend -->
...
<!-- * Tropics is undergoing a huge amount of land-use change, which historically was concentrated more in temperate regions -->

<!-- ### Forest conversion -->

<!-- * Required primarily for agriculture -->
...
<!-- * These forests still retain conservation value, so part of a pragmatic conservation approach is maximising their ability to sustain biodiversity under additional threats e.g. climate change -->

<!-- ## Climate change in the tropics -->

<!-- ### Vulnerability of tropical species -->

<!-- * Long periods of climatic stability in the tropics, with little seasonality in temperature -->
<!--     * Earliest appearance of novel climate -->
<!--     * Tropical species are likely to be less tolerant of temperature change -->
<!-- * Globally, organisms can avoid extinction under climate change by adapting in situ or shifting their range -->

<!-- ### In situ adaptation -->

<!-- * Includes physiological platicity, genetic adaptation and behaviour -->
...
<!-- * The many studies considering impacts of climate change hint at the importance of temperature for species' ecology -->

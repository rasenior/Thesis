...
__Figure D.10 removed to reduce file size.__
...
```{r fig-D-10, fig.cap= "(ref:cap-D-10)", fig.width = 5, fig.height = 1}
...
```{r fig-D-11, fig.cap= "(ref:cap-D-11)", fig.width = 5, fig.height = 1}
ggplot(data = data.frame(x = 1,
                         y = 1),
       aes(x = x, y = y)) + 
  geom_point(alpha = 0) +

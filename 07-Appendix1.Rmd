...
```{r fig-A-4, fig.cap= "(ref:cap-A-4)", fig.align='center', fig.width = 10/2.54, fig.height = 6/2.54}
...
```{r fig-A-1, fig.cap= "(ref:cap-A-1)",fig.height=22/2.54, fig.align='center'}
p1
...
```{r fig-A-2, fig.cap= "(ref:cap-A-2)",fig.height=22/2.54, fig.align='center'}
